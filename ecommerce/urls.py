...
"""
#Para usar archivos staticos en desarrollo
#en produccion es diferente 
...
from carts.views import cart_datail_api_view
...
urlpatterns = [
    ...
    url(r'^api/cart/$', cart_datail_api_view, name='api-cart'),
